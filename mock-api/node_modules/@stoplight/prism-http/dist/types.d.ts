...
export declare class ProblemJsonError extends Error {
    ...
    readonly additional?: Dictionary<unknown> | undefined;
    ...
    constructor(name: string, message: string, status: number, detail: string, additional?: Dictionary<unknown> | undefined);
}
