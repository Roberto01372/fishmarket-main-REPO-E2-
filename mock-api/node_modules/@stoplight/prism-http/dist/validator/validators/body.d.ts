...
export declare function deserializeFormBody(schema: JSONSchema, encodings: IHttpEncoding[], decodedUriParams: Dictionary<string>): E.Left<NEA.NonEmptyArray<IPrismDiagnostic>> | E.Right<{}>;
export declare function splitUriParams(target: string): E.Either<never, Dictionary<string>>;
